...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("block__item-change");
  ...
  //toggle .block__item-change on the parent.
  listItem.classList.toggle("block__item-change");
};
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var checkBox = taskListItem.querySelector(".block__checkbox");
  var editButton = taskListItem.querySelector(".block__change");
  var deleteButton = taskListItem.querySelector(".block__remove");
